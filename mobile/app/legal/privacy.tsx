...
export default function PrivacyScreen() {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <Text style={styles.bodyText}>
        Bereitstellung der App-Funktionen: Anmeldung, Speichern und Anzeigen
        deiner persönlichen Kinobesuch-Bibliothek.
      </Text>

      <Text style={styles.sectionTitle}>4. Rechtsgrundlage</Text>
      <Text style={styles.bodyText}>
        Art. 6 Abs. 1 lit. b DSGVO (Erfüllung des Nutzungsvertrags mit dir).
      </Text>
      ...
      <Text style={styles.bodyText}>
        • Supabase Inc. – Hosting, Datenbank, Authentifizierung, Dateispeicher
        (Serverstandort EU/Paris){"\n"}• The Movie Database (TMDB) – Filmsuche
        und Filmdaten{"\n"}• OpenAI – nur wenn du den Ticket-Scan nutzt: Analyse
        deines Ticketfotos zur Texterkennung{"\n"}• OpenStreetMap
        (Nominatim/Overpass) – nur bei der Kino-Suche: deine Sucheingabe wird
        übermittelt
      </Text>

      <Text style={styles.sectionTitle}>6. Speicherdauer</Text>
      <Text style={styles.bodyText}>
        Deine Daten werden gespeichert, bis du deinen Account löschst oder uns
